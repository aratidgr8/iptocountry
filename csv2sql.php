...
<form class="form-horizontal"action="csv2sql.php" method="post">
	...
	<div class="form-group">
		...
		<div class="col-xs-3">
        <input type="text" class="form-control" name="password" value="root" id="password" placeholder="">
		</div>
    </div>
	<div class="form-group">
        <label for="db" class="control-label col-xs-2">Database name</label>
		<div class="col-xs-3">
        <input type="text" class="form-control" name="db" id="db" value="ip2location" placeholder="">
		</div>
    </div>
	...
	<div class="form-group">
		...
		<div class="col-xs-3">
        <input type="name" class="form-control" name="table" value="ip2location_db3" id="table">
		</div>
    </div>
	<div class="form-group">
        <label for="csvfile" class="control-label col-xs-2">Name of the file</label>
		<div class="col-xs-3">
        <input type="name" class="form-control" name="csv" value="IP2LOCATION-LITE-DB3.CSV" id="csv">
		</div>
		eg. MYDATA.csv
    </div>
	<div class="form-group">
...
mysqli_query($cons, 'LOAD DATA LOCAL INFILE "'.$file.'" INTO TABLE '.$table.' FIELDS TERMINATED by \',\' ENCLOSED BY \'"\' LINES TERMINATED BY \'\r\n\' IGNORE 0 LINES')or die(mysql_error());
